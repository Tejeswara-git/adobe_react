...
const dropdownMenus = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'E-Sessions', href: '#/e-sessions', page: '/e-sessions' },
      { label: 'AD Sunshine', href: '#/sunshine', page: '/sunshine' },
      { label: 'Synergy', href: '#/synergy', page: '/synergy' },
      { label: 'Soaring Wings', href: '#/soaring-wings', page: '/soaring-wings' },
      { label: 'GYPSE', href: '#/gypse', page: '/gypse' },
      { label: 'Wise Talk', href: '#/wise-talk', page: '/wise-talk' },
      { label: 'Xper Talk', href: '#/xper-talk', page: '/xper-talk' },
      { label: 'Young Leader Speak', href: '#/young-leader-speak', page: '/young-leader-speak' },
      { label: 'Youth Impact', href: '#/youth-impact', page: '/youth-impact' },
    ],
  },
  {
    label: 'Webinars',
