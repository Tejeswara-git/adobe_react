  ...
  return (
    ...
    <a href="https://adore.ivdata.in/" className="top-btn">Login</a>
        ...
        <div className="top-right">
          ...
          <a
            href="https://www.linkedin.com/company/adore-official/"
            target="_blank"
            rel="noopener noreferrer"
          >
      ...
      <nav
        className={`navbar ${scrolled ? "scrolled" : ""} ${hideTopBar ? "top" : ""}`}
        id="navbar"
      >
        <div className="nav-container">
          <a href="#home" className="nav-logo">
            <img
              src="/images/ADORE.png"
              alt="Adore logo"
          ...
          <div className={`nav-links ${navOpen ? "open" : ""}`} id="nav-links">
            ...
            <a
              href="#participate"
              className={`nav-link ${activeSection === "participate" ? "active" : ""}`}
              onClick={() => setNavOpen(false)}
            >
              Participate
            </a>
            ...
            <a
              href="#releases"
              className={`nav-link ${activeSection === "releases" ? "active" : ""}`}
              onClick={() => setNavOpen(false)}
            >
              Releases
            </a>
          ...
          <div className="nav-actions">
            ...
            >
              <span
                style={{
                  transform: navOpen ? "rotate(45deg) translate(5px, 5px)" : "",
                }}
              ></span>
